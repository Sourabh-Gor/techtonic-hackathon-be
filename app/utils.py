...
def load_model():
    model = joblib.load('C:/Users/sou74/Desktop/tech-tonic/techtonic-hackathon-be/XGBclassifier.joblib')
    return model
...
def generate_report(analysis):
    # Example function to generate a report file (replace with your actual implementation)
    # Example: Save to a directory and return file path
    report_path = f"reports/report_{analysis.id}.txt"
    with open(report_path, 'w') as file:
        file.write(f"Report for URL Analysis ID: {analysis.id}\n")
        file.write(f"URL: {analysis.url}\n")
        file.write(f"Probability: {analysis.probability}\n")
